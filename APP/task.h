...
#define	TASK_CT361_INTERNAL_PRIO					10
#define TASK_CT361_INTERNAL_STKSIZE				100
EXTERN OS_STK TaskCT361InternalStk[TASK_CT361_INTERNAL_STKSIZE];
void TaskCT361Internal(void* p_arg);
#define TASK_TASKCT361INTERNAL_QSIZE      20u
EXTERN OS_EVENT* CT361INTERNALMBox;
EXTERN void* CT361InternalQBuff[TASK_TASKCT361INTERNAL_QSIZE];

#define	TASK_CT361_SEARCH_PRIO					11
#define TASK_CT361_SEARCH_STKSIZE				100
EXTERN OS_STK TaskCT361SearchStk[TASK_CT361_SEARCH_STKSIZE];
void TaskCT361Search(void* p_arg);
#define TASK_TASKCT361SEARCH_QSIZE      20u
EXTERN OS_EVENT* CT361SEARCHMBox;
EXTERN void* CT361SEARCHQBuff[TASK_TASKCT361SEARCH_QSIZE];
